    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
                <h2 class="text-4xl font-extrabold text-blue-600 mb-6 text-center">Calculadora - Método Ingenuo Estacional</h2>
                
                <form id="ingenuoEstacionalForm" action="{{ route('metodo.ingenuo_estacional.calculate') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label class="block font-semibold text-gray-700 mb-2" for="season_length">Longitud de la Temporada</label>
                        <input type="number" name="season_length" id="season_length" class="px-4 py-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Ejemplo: 4 para trimestral, 12 para anual">
                        <small class="text-gray-500 block mt-1">Ingresa la longitud de la temporada (número de períodos).</small>
                    </div>
...
<script type="text/javascript">
    ...
    document.getElementById('ingenuoEstacionalForm').addEventListener('submit', async function (event) {
