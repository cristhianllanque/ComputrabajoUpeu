    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
                <h2 class="text-4xl font-extrabold text-blue-600 mb-6 text-center">Calculadora - Método de la Media Móvil Simple</h2>
                
                <form id="mediaMovilForm" action="{{ route('metodo.media_movil.calculate') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label class="block font-semibold text-gray-700 mb-2" for="window">Tamaño de la Ventana (número de períodos)</label>
                        <input type="number" name="window" id="window" class="px-4 py-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Ejemplo: 3">
                        <small class="text-gray-500 block mt-1">Indica el tamaño de la ventana para el cálculo de la media móvil.</small>
                    </div>
...
<script type="text/javascript">
    ...
    document.getElementById('mediaMovilForm').addEventListener('submit', async function (event) {
