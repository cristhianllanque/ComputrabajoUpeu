    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-8 border border-gray-200">
                <!-- Título -->
                <h2 class="text-4xl font-extrabold text-blue-600 mb-6 text-center">Calculadora - Método de la Media</h2>

                <!-- Formulario de entrada -->
                <form id="mediaForm" action="{{ route('metodo.media.calculate') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
